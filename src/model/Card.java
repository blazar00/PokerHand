 ...
 * Description: Class where the Suit and Rank represent an actual card in a deck with a comparison method
 */
...
public class Card implements Comparable<Card> {
	...
	public boolean equals(Object other) {
		...
		return (this.getRank() == ((Card) other).getRank()) && (this.getSuit() == ((Card) other).getSuit());
	}
}